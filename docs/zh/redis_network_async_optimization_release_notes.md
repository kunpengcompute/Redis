...
## v26.1.0<a name="ZH-CN_TOPIC_0000002600000000"></a>

### 更新说明<a name="ZH-CN_TOPIC_0000002600000001"></a>

通过KrAIO调度Poll机制优化，提升在同物理机部署proxy、Redis的场景下本地网络交互性能。redis-benchmark通过网卡IP对本地Redis 7.0.15单实例压测set、get命令在2C2T场景下性能提升5%。


### 已解决的问题<a name="ZH-CN_TOPIC_0000002600000002"></a>

无。


### 遗留问题<a name="ZH-CN_TOPIC_0000002600000003"></a>
